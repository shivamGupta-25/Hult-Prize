  ...
  "2025": [
    {
      ...
      about: {
        description:
          "An intensive virtual workshop series designed to empower students with critical tools for professional competitiveness.",
        vision:
          "To empower participants with a critical set of practical skills to significantly enhance their professional competitiveness.",
        mission: [
      ...
      stats: {
        participants: "400+",
        registrations: "268",
        reach: "10,000+ Instagram Impressions, 3,000+ WhatsApp Reach",
      ...
      content: {
        ...
        agenda: [
          {
            day: "Day 1",
            theme: "The Professional Brand",
            sessions: [
              {
                title: "LinkedIn Profile Building",
                speaker: "Madhur Jain",
                image: "/Events/CareerCon/LinkedInProfile Building_Poster.jpg",
                focus: [
  ...
  "2023": [
    {
      ...
      about: {
        description:
          "A strategy conclave featuring ethical dilemmas, case studies, and live auction simulations.",
        vision:
          "To evaluate real-world strategic thinking under ethical and competitive constraints.",
        mission: [
        ...
        subEvents: [
          {
            id: "ethiquest",
            name: "Ethiquest",
            tagline: "The Corporate Social Challenge",
            description:
              "CSR-centric challenge balancing profitability, ethics, and social impact.",
            prizes: "₹15,000",
            image: "/Events/Ranneeti/Ranneeti1.0_Posters/EthiquestPoster.jpg",
            phases: [
              {
                name: "Prelims",
                mode: "Online",
