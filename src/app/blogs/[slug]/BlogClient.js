  ...
  useEffect(() => {
    if (slug) {
      if (!initialBlog) {
        ...
        // If we have an initial blog, just increment view and fetch engagement
        // We need to ensure we don't increment view on every render, strictly once per slug mount
